...
//            $category = $this->getCategoryNameForGivenProduct($product);
            $category = 'Robotic Floor Cleaners';
            $country = "India";
...
//        }
        $selectedProduct='';
        $productSelected=Tools::getValue('p');
        if(!empty($productSelected))
        if(strcasecmp($productSelected,'RedHawk')==0)
        {
            $selectedProduct='RedHawk';
        }
        elseif(strcasecmp($productSelected,'SuperBot'))
        {
            $selectedProduct='SuperBot/RoboCop';
        }
        elseif(strcasecmp($productSelected,'RoboCop'))
        {
            $selectedProduct='SuperBot/RoboCop';
        }
