...
//        $this->ps_versions_compliancy = array('min' => '1.5', 'max' => '1.5');
        ...
        $this->displayName = $this->l('warranty');
        $this->description = $this->l('This module will register product for warranty');
    ...
    public function install()
    {
        ...
        include_once(_PS_MODULE_DIR_ . '/' . $this->name . '/warranty_install.php');
        $warrantyInstall = new WarrantyInstall();
        $warrantyInstall->createTables();
