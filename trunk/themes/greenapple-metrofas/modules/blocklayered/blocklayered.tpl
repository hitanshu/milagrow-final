...
<div id="layered_block_left" class="block block-verticalmenu">
 ...
 <div class="block-title ma-new-vertscroller-title"><strong><span class="word1">{l s='Shop' mod='blocklayered'}</span> <span class="word2">{l s=' By' mod='blocklayered'}</span> </strong></div>
			...
			<div>
				...
				<div id="enabled_filters">
					<span class="layered_subtitle" style="float: none;">{l s='Enabled filters:' mod='blocklayered'}</span>
                                        <ul id="ma-accordion" class="left-categorys-container accordion">
				...
				{foreach from=$filters item=filter}
					{if isset($filter.values)}
						...
						<span class="layered_close closed"><a href="#" rel="ul_layered_{$filter.type}_{$filter.id_key}">&lt;</a></span>
						<div class="clear"></div>
