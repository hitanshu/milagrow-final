...
{if !isset($email_create)}
            ...
            $.ajax({
                ...
                success: function (jsonData) {
                    if (jsonData.hasError) {
                        ...
                        $('#center_column').html('<div class="ma-main-container col1-layout"><div class="container"><div class="main"><div id="noSlide">' + $('#center_column').html() + '</div></div></div></div>');
    ...
    <div class="col2-set">
        <div class="col-1 new-users box-in">
            <div class="content">
                ...
                <form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form">
                    ...
                    <ul class="form-list">
                        <li>
                            <label for="email_create" class="required"><em>*</em>{l s='E-mail address'}</label>
        ...
        <div class="col-2 registered-users box-in">
            <div class="content">
                <form action="{$link->getPageLink('authentication', true)}" method="post" id="login_form">

                    <h2>{l s='Already registered?'}</h2>

                    <p>{l s='If you have an account with us, please log in.'}</p>
                    <ul class="form-list">
                        <li>
                            <label for="email" class="required"><em>*</em>{l s='E-mail address'}</label>

                            <div class="input-box">
                                <input type="text" id="email" name="email"
                                       value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}"
                                       class="account_input input-text required-entry "/>

                            </div>
                        </li>
                        <li>
                            <label for="pass" class="required"><em>*</em>{l s='Password'}</label>
                    ...
                    <p class="required">*{l s='Required Fields'}</p>
    ...
    <div class="col2-set">
        <div class="col-1 new-users">
            <div class="buttons-set">
                ...
                <button type="button" id="SubmitCreate" name="SubmitCreate" class="button">
                    <span><span>{l s='Create an account'}</span></span></button>
                <input type="hidden" class="hidden" name="SubmitCreate" value="{l s='Create an account'}"/>
            </div>
        </div>
        <div class="col-2 registered-users">
            <div class="buttons-set">
                <a class="f-left" href="{$link->getPageLink('password')}">{l s='Forgot your password?'}</a>
                {if isset($back)}<input type="hidden" class="hidden" name="back"
                                        value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
                <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button">
                    <span><span>{l s='Log in'}</span></span></button>
    ...
    {if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
        <form action="{$link->getPageLink('authentication', true, NULL, "back=$back")}" method="post"
              id="new_account_form" class="std clearfix">
            <div class="col2-set">

                <div class="content">
                    <fieldset>
                        <h2>{l s='Instant Checkout'}</h2>

                        <div id="opc_account_form" style="display: block; ">
                            <!-- Account -->
                            <p class="required text">
                                <label for="guest_email">{l s='E-mail address'} <sup>*</sup></label>
                                <input type="text" class="text" id="guest_email" name="guest_email"
                            ...
                            <p class="required text">
                                ...
                                <input type="text" class="text" id="firstname" name="firstname"
                                       onblur="$('#customer_firstname').val($(this).val());"
                                       value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{/if}">
                                <input type="hidden" class="text" id="customer_firstname" name="customer_firstname"
                                       value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{/if}">
                            </p>
                            ...
                            <p class="required text">
                                ...
                                <input type="text" class="text" id="lastname" name="lastname"
                                       onblur="$('#customer_lastname').val($(this).val());"
                                       value="{if isset($smarty.post.lastname)}{$smarty.post.lastname}{/if}">
                                <input type="hidden" class="text" id="customer_lastname" name="customer_lastname"
                                       value="{if isset($smarty.post.lastname)}{$smarty.post.lastname}{/if}">
                            </p>
                ...
                <div class="col2-set">
                    ...
                    <div class="buttons-set">
                        ...
                        <button type="submit" class="button" name="submitGuestAccount" id="submitGuestAccount">
                            <span><span>{l s='Continue'}</span></span></button>
                    </div>
    ...
    {if $b2b_enable}
        <fieldset class="account_creation">
            ...
            <p class="text">
                ...
                <input type="text" class="text" id="siret" name="siret"
                       value="{if isset($smarty.post.siret)}{$smarty.post.siret}{/if}"/>
            </p>

            <p class="text">
                <label for="ape">{l s='APE'}</label>
                <input type="text" class="text" id="ape" name="ape"
                       value="{if isset($smarty.post.ape)}{$smarty.post.ape}{/if}"/>
            </p>

            <p class="text">
                <label for="website">{l s='Website'}</label>
                <input type="text" class="text" id="website" name="website"
