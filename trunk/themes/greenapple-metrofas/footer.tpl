            ...
            <div class="contain-size">
                <div class="ma-footer-static">
                    <div class="row-fluid show-grid">
                        ...
                        <div class="span3 fcol1">
                            <div class="footer-static-title">
                                <h3><a style="text-decoration: none;" href="/content/8-downloads">Downloads</a></h3>
                            </div>
                            <div class="footer-static-content">
                                <ul class="last">
                        ...
                        <div class="span3 fcol1">
                            ...
                            <div class="footer-static-content">
                                <ul class="last">
                                    ...
                                    <li><a href="/contact-us">Customer Service Query</a></li>
                                    <li><a href="/book-demo">Book a Demo</a></li>
                                    <li><a href="/bulk-purchase">Bulk Purchase Query</a></li>
                                    <li><a href="mailto:customercare@milagrow.in">Contact Us</a></li>
                                </ul>
                            </div>
